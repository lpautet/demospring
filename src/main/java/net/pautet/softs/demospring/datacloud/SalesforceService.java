package net.pautet.softs.demospring.datacloud;

import lombok.extern.slf4j.Slf4j;
import net.pautet.softs.demospring.datacloud.internal.config.ConnectorSchemaProvider;
import net.pautet.softs.demospring.datacloud.internal.config.SalesforceConfig;
import net.pautet.softs.demospring.datacloud.internal.model.DataCloudIngestResponse;
import net.pautet.softs.demospring.datacloud.internal.service.SalesforceAuthService;
...
import static net.pautet.softs.demospring.weather.NetatmoService.*;
...
public class SalesforceService {
    ...
    public boolean isConfigured() {
        return salesforceConfig.privateKey() != null;
    }
