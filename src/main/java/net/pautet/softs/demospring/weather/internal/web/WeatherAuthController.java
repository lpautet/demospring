...
class WeatherAuthController {
    ...
    ResponseEntity<String> authorize(@RequestParam String id) {
    ...
    ResponseEntity<String> callback(@RequestParam String state, @RequestParam String code) throws IOException {
